...
//comment by jidzh@2018-01-23,it has risk of cross border
static size_t _buffered_data_writer_callback(char* ptr,size_t sz,size_t n,void* pblock)
{
    ...
    p->used+=sum;
	//modify by jidz@2018-01-23
    return sum;/// follow fwrite return result.
}
...
//modify by jidz@2018-01-24,Í¨ÓÃÐÔºÃÒ»µã
...
{
	return invokeLib(curl_easy_setopt, _p->c, CURLOPT_SSL_VERIFYHOST, enable ? 1 : 0);
}
...
void HTTPConnection::HTTPConnectDebugPrint()
{
}
